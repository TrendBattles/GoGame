...
void KataGoManager::set(const std::string& workingDir, const std::string& modelName) {
    ...
    const std::string FULL_COMMAND_WITH_PATH = ABS_EXE_PATH + " gtp -model " + modelName + " -config analysis.cfg";
